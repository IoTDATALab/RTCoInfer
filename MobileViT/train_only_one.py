...
def get_meters(phase):
    ...
    def get_single_meter(phase, suffix=''):
        ...
        return meters
    meters = {}
    for width_mult, _quantbits in FLAGS.train_only_one:
...
def run_one_epoch(
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        if train:
            ...
            optimizer.zero_grad()
            train_tmp=FLAGS.train_only_one
    ...
    if is_master() and train:
        for width_mult,_quantbits in FLAGS.train_only_one:
                ...
                with open('exp_train_one_database.txt','a+') as f:
...
def train_val_test():
    ...
    for epoch in range(last_epoch+1, FLAGS.num_epochs):
        ...
        # val
        if epoch>0.75*FLAGS.num_epochs:
            ...
            if is_master() and results['top1_error'] < best_val:
                ...
                os.path.join(FLAGS.log_dir, 'initialization_model.pt'))
